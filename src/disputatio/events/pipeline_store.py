...
class FilePipelineStateStore:
    ...
    def save(self, state: PipelineState) -> None:
        ...
        (`events.file_lock`) — дополнительная защита, а не поддержка
        конкурентной записи: писатель у пайплайна один (SPEC-002 P11), и
        обеспечивает это операторская дисциплина. При её нарушении два
