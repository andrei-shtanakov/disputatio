...
REQUIREMENT_COVERAGE: Final[tuple[tuple[str, str], ...]] = (
    ...
    ("REQ-003", "runtime/test_history_round_integrity.py"),
    ...
    ("REQ-009", "runtime/test_budget_all_attempts.py"),
...
PIPELINE_COVERAGE: Final[tuple[tuple[str, str], ...]] = (
    ...
    ("SPEC-002 §2 P9", "runtime/test_pipeline_integrity_perimeter.py"),
    ("SPEC-002 §5.3", "runtime/test_findings_item_text_copies.py"),
    ...
    ("SPEC-002 §4.1", "runtime/test_pipeline_layout_mirror.py"),
