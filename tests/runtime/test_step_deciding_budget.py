...
* **повтор над решением прежней версии** (без снимка) — такое решение
  авторитетно: снимок в него не дописывается, прогноз для раунда не
  применяется, переход идёт по записанному исходу. Повтор над решением
  новой версии воспроизводит его байт-в-байт.
"""
