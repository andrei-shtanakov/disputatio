...
- [ ] Автоматизация полировки пары спека+план протоколом раундов @id:spec-pair-polish-automation
  ...
  ревью нашло **12 major + 1 minor**, из них пять — fail-open в защитах, ради
  ...
  **не публиковался**: штатный путь отказал, отпечаток не вычислен, ручное
  ...
  (`f7a03d6`) не трогать. Починены: C3 `d0703cb`, A5 `836330b`, D1 `27791f6`,
  D3 `677f1dd` (suite 1814). Открыты 9 major; порядок: (1) общий парсер с
