...
- [ ] maestro: `validate --strict` не эскалирует warnings вопреки README —
  находка D2, заведена как maestro#163; за владельцем maestro.
  @id:maestro-strict-warnings-finding
